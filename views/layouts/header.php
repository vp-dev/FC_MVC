...
<head>
    ...
    <link href="/template/css/tables.css" rel="stylesheet">
                ...
                <div class="col-sm-6">
                    <div class="contactinfo">
                        <ul class="nav nav-pills">
                            <li><a href="#"><i class="fa fa-phone"></i> +7 978 1234567</a></li>
                            <li><a href="#"><i class="fa fa-envelope"></i> videoprism@mail.ru</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-sm-6">
